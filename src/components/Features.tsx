...
const addOns = [
  ...
  {
    title: "AI Chatbot Integration Add-On",
    description: "Advanced AI chatbot customized for your business to handle customer inquiries, qualify leads, and provide 24/7 support.",
    price: "$350 setup + $120/month",
    icon: MessageSquare,
  },
  {
    title: "AI SEO Optimization Add-On",
    description: "Comprehensive AI-driven SEO strategy with keyword research, content optimization, and regular performance tracking.",
    price: "$450/month",
    icon: Brain,
  },
  {
    title: "AI Business Automation Add-On",
    description: "Custom automation solutions using AI to streamline your business processes, reduce manual tasks, and improve efficiency.",
    price: "$750 setup + $200/month",
    icon: Zap,
  },
  {
    title: "AI Data Analysis & Insights Add-On",
    description: "Deep analysis of your website data using AI to provide actionable business insights and strategic recommendations.",
    price: "$400/month",
    icon: BarChart,
  }
];
